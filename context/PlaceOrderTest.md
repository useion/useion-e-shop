# Test tests/features/order.feature
...
Feature: Place order
    ...
    Scenario: Placing order with the bank transfer payment method
    ...
    Scenario: Placing order with PayPal
        ...
        Then system requests billing system for charging me for the order
        And billing system confirms that I was charged
        And system notifies user that was charged
